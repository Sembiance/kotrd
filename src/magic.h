...
DECLARE_SPELL_FUN(	spell_fortify_object	);
...
DECLARE_SPELL_FUN(      spell_golden            );
...
DECLARE_SPELL_FUN(spell_obfuscate         );
DECLARE_SPELL_FUN(spell_bio_fortress       );
...
/* New Spells */
DECLARE_SPELL_FUN(spell_forsake		);
DECLARE_SPELL_FUN(spell_divine_wrath	);
DECLARE_SPELL_FUN(spell_sonic_scream	);
DECLARE_SPELL_FUN(spell_create_zombie	);
DECLARE_SPELL_FUN(spell_metamorph	);
...
DECLARE_SPELL_FUN(	spell_wyldstryke	);
DECLARE_SPELL_FUN(	spell_acid_storm	);
DECLARE_SPELL_FUN(	spell_wail_banshee	);
DECLARE_SPELL_FUN(	spell_torment_cold	);


/* NPC/IMP only spells */
DECLARE_SPELL_FUN(	spell_immdis_magic	);
DECLARE_SPELL_FUN(	spell_pdrain_blade	);
DECLARE_SPELL_FUN(	spell_pshocking_blade	);
DECLARE_SPELL_FUN(	spell_pflame_blade	);
DECLARE_SPELL_FUN(	spell_pfrost_blade	);
DECLARE_SPELL_FUN(	spell_psharp_blade	);
DECLARE_SPELL_FUN(	spell_pvorpal_blade	);
DECLARE_SPELL_FUN(	spell_ppoison_blade	);
